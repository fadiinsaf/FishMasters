...
<body class="bg-background-light dark:bg-background-dark text-[#181411] dark:text-white font-display">
    <div class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <header
            class="flex items-center justify-between border-b border-[#e6dfdb] dark:border-[#3e2c21] bg-white dark:bg-[#1e140d] px-10 py-3 sticky top-0 z-50">
            ...
            <div class="flex flex-col max-w-[1400px] flex-1 w-full gap-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
                    ...
                    <aside class="w-full space-y-6">
                        <div
                            class="bg-white dark:bg-[#1e140d] rounded-xl border border-[#e6dfdb] dark:border-[#3e2c21] p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div
                            class="group bg-white dark:bg-[#1e140d] rounded-xl border border-[#e6dfdb] dark:border-[#3e2c21] shadow-sm overflow-hidden hover:shadow-md transition-all flex flex-col">
                            <div class="h-48 w-full bg-cover bg-center relative"
                                style="background-image: url('https://api.dicebear.com/7.x/initials/svg?seed=<?= urlencode($f['nom_complet']) ?>');">
                            ...
                            <div class="p-5 flex flex-col flex-1">
                                ...
                                <div
                                    class="grid grid-cols-2 gap-2 py-3 border-t border-b border-[#e6dfdb] dark:border-[#3e2c21] mb-4 bg-gray-50 dark:bg-[#2a1e16] rounded-lg text-center">
                                    <div>
                                        <span class="block text-xs font-bold text-[#8c725f] uppercase">Points</span>
                                        <span class="block text-lg font-bold text-primary">
                                            <?= number_format($f['score_total'] ?? 0) ?>
                                        </span>
                                    </div>
                                ...
                                <a href="index.php?action=profile&id=<?= $f['id'] ?>"
                                    class="mt-auto w-full py-2.5 rounded-lg bg-primary hover:bg-orange-600 text-white text-sm font-bold flex items-center justify-center gap-2 transition-colors">
                                    Voir Profil
                        ...
                        <?php endforeach; ?>
                        <?php else: ?>
                        <p class="col-span-full text-center py-10 text-gray-500">Aucun pêcheur trouvé dans la base de
                            données.</p>
                        <?php endif; ?>
